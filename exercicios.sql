...
select idFuncionario, nome from funcionarios where departamento = 'Filmes' or departamento = 'Roupas'; --CORRETO

/*2 - O gestor de Marketing pediu a lista das funcionárias que trabalhem no departamento de filmes ou no departamento de lar. Ele necessita enviar um email para as 
colaboradoras desse setor.*/
select idFuncionario, nome from funcionarios where sexo = 'Feminino' and (departamento = 'Filmes' or departamento = 'Lar'); --CORRETO

/*3 - Traga os funcionários do sexo masculino ou os funcionários que trabalhem no setor Jardim.*/
select nome from funcionarios where sexo = 'Masculino' or (sexo = 'Masculino' and departamento = 'Jardim');


/* RASCUNHO */
/*selecione tudo de departamento da tabela funcionario e agrupe por departamento e ordene*/
...
select count(*), departamento from funcionarios group by departamento order by 1;
--21 funcionários em filmes 
--53 funcionários em roupas
/*Foi chamado antes o departamento de roupas devido ao alto volume de funcionarios depois o outro departamento*/
